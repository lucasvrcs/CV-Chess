...
def create_visualization(result):
    ...
    ax1.set_title("RT-DETR Detections")
...
def detect_chess_pieces(image_path, model_path='rt_chess_model.pt', annotations_path='annotations.json'):
    """
    Main function to detect chess pieces using RT-DETR and return visualization figure.
